<div class="relative" x-data="{ isOpen: true }" @click.away="isOpen = false">
    <input wire:model.debounce.500ms="search" type="text" class="bg-gray-800 text-sm rounded-full w-64 px-4 pl-8 py-1" placeholder="Search" @focus="isOpen = true" x-ref="search" @keydown.window="if (event.keyCode === 191) event.preventDefault(); $refs.search.focus()">
