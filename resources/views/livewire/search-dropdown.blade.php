<div class="relative">
    <input wire:model.debounce.500ms="search" type="text" class="bg-gray-800 text-sm rounded-full w-64 px-4 pl-8 py-1" placeholder="Search">
    ...
    @if (strlen($search) >= 2)
        <div class="z-10 absolute bg-gray-800 text-sm rounded mt-2 w-64">
