<nav class="flex items-center justify-between flex-wrap border-b border-gray-800 p-6">
    ...
    <div class="block xl:hidden">
        <button class="navbar-mobile-toggle flex items-center px-3 py-2 text-gray-500 hover:text-gray-300">
    ...
    <div class="navbar-mobile w-full ml-4 block flex-grow hidden xl:flex xl:items-center xl:w-auto xl:ml-0">
        ...
        <div class="flex items-center mt-4 xl:mt-0">
            <div class="relative">
                <input type="text" class="bg-gray-800 text-sm rounded-full w-64 xl:w-64 px-4 pl-8 py-1" placeholder="Search">
