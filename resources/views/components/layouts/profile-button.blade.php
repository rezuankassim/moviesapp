<div class="ml-4 relative inline-block text-left" x-data="{ isOpen: false }" @keydown.escape="isOpen = false" @click.away="isOpen = false">
    ...
    <div x-show="isOpen" x-transition:enter="transition ease-out duration-100" x-transition:enter-start="transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" x-transition:leave="transition ease-in duration-75" x-transition:leave-start="transform opacity-100 scale-100" x-transition:leave-end="transform opacity-0 scale-95" class="origin-top-right absolute right-0 mt-2 w-56 rounded-md shadow-lg z-20">
        <div class="rounded-md bg-gray-800 shadow-xs">
            <div class="py-1">
                <a href="#" class="block py-2 text-sm leading-5 text-white flex items-center hover:bg-gray-100 hover:text-gray-900 focus:outline-none focus:bg-gray-100 focus:text-gray-900">
                ...
                <a href="#" class="block py-2 text-sm leading-5 text-white flex items-center hover:bg-gray-100 hover:text-gray-900 focus:outline-none focus:bg-gray-100 focus:text-gray-900" @click="event.preventDefault(); document.querySelector('#logout-form').submit()">
                    <div class="px-3 text-gray-500">
